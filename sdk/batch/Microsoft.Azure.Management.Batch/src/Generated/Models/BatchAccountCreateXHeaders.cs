...
namespace Microsoft.Azure.Management.Batch.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateX operation.
    /// </summary>
    public partial class BatchAccountCreateXHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BatchAccountCreateXHeaders class.
        /// </summary>
        public BatchAccountCreateXHeaders()
        {
            CustomInit();
        }
        ...
        public BatchAccountCreateXHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
